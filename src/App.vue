<template>
  <div>
    <header class="header">
      <label for="">
        Escribe el Pokemon que quieras buscar Por ID:
        <input type="text" v-model="pokemonID" placeholder="Ej: 25" />
    ...
    async searchPokemon() {
      try {
       ...
       return pokemon;
        ...
        alert("Error al buscar el Pokémon. Por favor, inténtalo de nuevo.");
      }
    }
  }
}
